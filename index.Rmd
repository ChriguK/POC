...
pc <- gvisPieChart(my.data, labelvar = "Y.NA", numvar = "Y.2012", options=list(width=1000, height=450, pieHole=0.4, pieResidueSliceLabel="Rest", chartArea="{left:0,top:100,width:900,height:300}", legend="{position: 'right'}"))
plot(pc)
```
